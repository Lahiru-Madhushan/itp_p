              ...
              return (
                ...
                >
                  ...
                  <div className="p-6 space-y-2">
                    <h2 className="text-lg font-bold text-gray-900 line-clamp-2 group-hover:text-yellow-600 transition-colors">
                      {product.name}
                    </h2>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <input
                    ...
                    className="w-20 border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-yellow-400 outline-none"
                  />
                </div>
